...
<div class="user" style="">
  <div class= "container" style="">
    <form class="form-signin" style="" novalidate>
      <img id="logo" src="<?=base_url('assets/logo.png')?>" width="118.91" height="28.08">
      <!-- <div class="input-wrapper" autocomplete="true"> -->
        <input type="text" id="inputEmail" class="form-control" placeholder="Your email" spellcheck="false" required>
      ...
      <script>
        ...
        (function() {
          ...
          window.addEventListener('load', function() {
            ...
            var forms = document.getElementsByClassName('from-signin');
