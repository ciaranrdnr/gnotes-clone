...
<form action="<?php if($data == null) echo site_url('Newnote_controller/addNotes'); else echo site_url('Newnote_controller/do_edit/'.$data->id_notes) ?>" method="POST">
   ...
   <div class="editor-group" style="width:720px; height:410px; position:absolute; left:400px; top:50px;">
      <div class="editorHeader" style="background-color:white; height:72px; margin-bottom:16px; border-bottom: 0.5px solid #BEBEBE;">
        <div style="display:inline-block;">
            ...
            <button type="submit" value="upload" class="btn btn-light" style="color: #372020 !important;height:32px; width:74px; border: 1px solid #D8D8D8; border-top-right-radius: 0px;
    border-bottom-right-radius: 0px;">
            ...
            <button type="button" class="btn btn-light dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" style="border: 1px solid #D8D8D8;height:32px;color: #372020 !important;">
                <span class="caret"></span>
                    ...
                    <div class="dropdown-menu ardown" >
                        <a class="dropdown-item" type="submit" value="upload" href="#">Save</a>
            ...
            <div>
                        <a type="file" name="berkas" class="fileUpload right"href="" role="button">
          ...
          <div>
            ...
            <div>
                        <a class="trash right"href="<?php if ($data != null) echo site_url('Newnote_controller/do_delete/'.$data->id_notes)?>" role="button">
      ...
      <textarea name="note" id="note" cols="95" rows="16" style="border: none;"><?php if($data!=null) echo $data->note?></textarea>
      </div>
   </div>
</form>
  </div>